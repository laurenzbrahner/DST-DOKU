...
Zusätzlich habe ich Streamlit für die Erstellung des Reports verwendet.
...
Für die Erstellung des Reports habe ich die meiner Meinung nach wichtigsten und aussagekräftigsten Graphen meines Projekts genutzt. Da die maximale Präsentationszeit bei 10 Minuten lag, musste ich mich auch in der Präsentation kurz halten und somit auch nur die wichtigsten Charts zeigen. Ich habe lediglich die beiden Graphen mit den Top-Künstlern und den Top-Songs weggelassen. Außerdem habe ich für das Report die detaillierten (gelayerten) Charts verwendet. Diese habe ich mit Text versehen, um die wichtigsten Erkenntnisse meines Projekts nochmals klar darzustellen. Dazu habe ich über das jeweilige Diagramm ein kurzen Text, der erklärt um was es in dem Graphen geht und was die Merkmale bedeuten verfasst. Neben dem Graphen habe ich die Auffälligkeiten in ihm erwähnt und unter ihm eine Handlungsempfehlung.
 Diese Erkenntnisse wurden von mir am Ende nochmals als Formel zusammengefasst.
